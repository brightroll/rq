...
module RQ
  class Commands
    ...
    def self.cmd_statuscountmesg(args)
      full_mesg_id = args['msg_id']
      raise RQ::RqMissingArgument if not full_mesg_id
    ...
    def self.cmd_attachstatusmesg(args)
      full_mesg_id = args['msg_id']
      raise RQ::RqMissingArgument if not full_mesg_id
    ...
    def self.cmd_verify_rules(args)
