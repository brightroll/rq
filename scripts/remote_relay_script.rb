...
remote_q_uri = 'http://stone-rq2.dev.btrll.com:3333/q/relay'
remote_delivery = true
fake_fail = false

# Send message to the relay queue on another host.
# FIXME: Woe be unto thee if the remote host is this host.
